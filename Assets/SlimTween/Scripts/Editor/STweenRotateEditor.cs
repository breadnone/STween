...
namespace Breadnone.Editor
{
    ...
    [CustomEditor(typeof(STweenRotate))]
    public class STweenRotateEditor : UnityEditor.Editor
    {
        private VisualElement objectContainer;
        private VisualElement objectContainerContent;
        public override VisualElement CreateInspectorGUI()
        {
            var t = target as STweenRotate;
            ...
            roots.Add(DrawDestinationX(t));
            roots.Add(DrawDestinationY(t));
            roots.Add(DrawDestinationZ(t));
        ...
        private VisualElement DrawEnumIsGameObject(STweenRotate t)
        {
        ...
        private VisualElement DrawGameObjectContainer(STweenRotate t)
        {
            var root = new VisualElement();
        ...
        public VisualElement DrawDuration(STweenRotate t)
        {
            var root = new VisualElement();
            root.style.marginTop = 5;
            root.style.flexDirection = FlexDirection.Row;
        ...
        public VisualElement DrawLoopCount(STweenRotate t)
        {
            var root = new VisualElement();
            root.style.marginTop = 5;
            root.style.flexDirection = FlexDirection.Row;
        ...
        public VisualElement DrawDelay(STweenRotate t)
        {
            var root = new VisualElement();
            root.style.marginTop = 5;
            root.style.flexDirection = FlexDirection.Row;
        ...
        public VisualElement DrawSpeed(STweenRotate t)
        {
            var root = new VisualElement();
            root.style.marginTop = 5;
            root.style.flexDirection = FlexDirection.Row;
        ...
        VisualElement ease;
        public VisualElement DrawEase(STweenRotate t)
        {
        ...
        private VisualElement DrawDestinationX(STweenRotate t)
        {
            var template = VTweenTemplate.SliderField("X ", 0f, 180f);
            template.slider.value = t.to.x;
            template.slider.showInputField = true;

            template.slider.RegisterValueChangedCallback(s =>
            {
                t.to = new Vector3(s.newValue, t.to.y, t.to.z);
            });

            return template.root;
        }
        private VisualElement DrawDestinationY(STweenRotate t)
        {
            var template = VTweenTemplate.SliderField("Y ", 0f, 180f);
            template.slider.value = t.to.y;
            template.slider.showInputField = true;

            template.slider.RegisterValueChangedCallback(s =>
            {
                t.to = new Vector3(t.to.x, s.newValue, t.to.z);
            });

            return template.root;
        }
        private VisualElement DrawDestinationZ(STweenRotate t)
        {
            var template = VTweenTemplate.SliderField("Y ", 0f, 180f);
            template.slider.value = t.to.z;
            template.slider.showInputField = true;

            template.slider.RegisterValueChangedCallback(s =>
            {
                t.to = new Vector3(t.to.x, t.to.y, s.newValue);
            });

            return template.root;
        }
        private VisualElement DrawPingpong(STweenRotate t)
        {
        ...
        private VisualElement DrawID(STweenRotate t)
        {
            var root = new VisualElement();
            root.style.flexDirection = FlexDirection.Row;
            root.style.width = new StyleLength(new Length(100, LengthUnit.Percent));
        ...
        private VisualElement DrawName(STweenRotate t)
        {
            var root = new VisualElement();
            root.style.flexDirection = FlexDirection.Row;
            root.style.width = new StyleLength(new Length(100, LengthUnit.Percent));
        ...
        private VisualElement DrawAnimationCurves(STweenRotate t)
        {
            var root = new VisualElement();
            animationCurve = root;
        ...
        private VisualElement DrawOnCompleteDestroy(STweenRotate t)
        {
        ...
        private VisualElement DrawEasingFunction(STweenRotate t)
        {
        ...
        private VisualElement DrawOnComplete(STweenRotate t)
        {
        ...
        private VisualElement DrawUnscaled(STweenRotate t)
        {
        ...
        private VisualElement DrawCancel(STweenRotate t)
        {
        ...
        private VisualElement DrawWorldSpace(STweenRotate t)
        {
        ...
        private VisualElement DrawOnCompleteRepeat(STweenRotate t)
        {
        ...
        private VisualElement DrawAxes(STweenRotate t)
        {
            var template = VTweenTemplate.Direction();
            template.dropdown.value = t.axis.ToString();

            template.dropdown.RegisterValueChangedCallback(x =>
            {
                foreach (var item in Enum.GetValues(typeof(STDirection)))
                {
                    if (x.newValue == item.ToString())
                    {
                        t.axis = (STDirection)item;
                        break;
                    }
                }
            });
        ...
        //AUDIO PART HERE
        private VisualElement DrawAudioSource(STweenRotate t)
        {
            var root = new VisualElement();
            root.style.flexDirection = FlexDirection.Row;
            root.style.width = new StyleLength(new Length(100, LengthUnit.Percent));
        ...
        private VisualElement DrawAudioFade(STweenRotate t)
        {
            var root = new VisualElement();
            root.style.flexDirection = FlexDirection.Row;
            root.style.width = new StyleLength(new Length(100, LengthUnit.Percent));
        ...
        private VisualElement DrawCancelAudio(STweenRotate t)
        {
            var root = new VisualElement();
            root.style.flexDirection = FlexDirection.Row;
            root.style.width = new StyleLength(new Length(100, LengthUnit.Percent));
        ...
        private VisualElement Controller(STweenRotate t)
        {
